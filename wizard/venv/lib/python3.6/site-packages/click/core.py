...
def augment_usage_errors(ctx, param=None):
    """Context service_manager that attaches extra information to exceptions that
    fly.
    """
    try:
        yield
...
class Context(object):
    ...
    A context can be used as context service_manager in which case it will call
    ...
    def scope(self, cleanup=True):
        ...
        used as a context service_manager.
