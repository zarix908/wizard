...
class TempDirectory(object):
    ...
    This class can be used as a context service_manager or as an OO representation of a
    temporary directory.
    ...
    When used as a context service_manager, a temporary directory is created on
